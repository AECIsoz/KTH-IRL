    ...
    if ($conn->query($sql) === TRUE) {
      ...
      if ($conn->query($sql) === TRUE) {
        ...
        if ($conn->query($sql) === TRUE) {
          ...
          $sql = "UPDATE IRLscales SET L5isReached='FFCC00', L4isReached='F7B101', L3isReached='EC6607', L2isReached='E63312', L1isReached='AE0F0B', L9isReached='f2f2f2', L8isReached='f2f2f2', L7isReached='f2f2f2', L6isReached='f2f2f2', CardColor1='E6E6E6', CardColor2='E6E6E6', CardColor3='E6E6E6', CardColor4='E6E6E6', CardColor5='E6E6E6', CardColor6='ffffff', CardColor7='ffffff', CardColor8='ffffff', CardColor9='ffffff' WHERE id=$id";
          if ($conn->query($sql) === TRUE) {
            header("Location: dashboard.php");
            } else {
              echo "Error updating record: " . $conn->error;
            ...
            $sql = "UPDATE IRLscales SET L6isReached='AECB54', L5isReached='FFCC00', L4isReached='F7B101', L3isReached='EC6607', L2isReached='E63312', L1isReached='AE0F0B', L9isReached='f2f2f2', L8isReached='f2f2f2', L7isReached='f2f2f2', CardColor1='E6E6E6', CardColor2='E6E6E6', CardColor3='E6E6E6', CardColor4='E6E6E6', CardColor5='E6E6E6', CardColor6='E6E6E6', CardColor7='ffffff', CardColor8='ffffff', CardColor9='ffffff' WHERE id=$id";
            if ($conn->query($sql) === TRUE) {
              header("Location: dashboard.php");
              } else {
                echo "Error updating record: " . $conn->error;
              ...
              $sql = "UPDATE IRLscales SET L7isReached='73B959', L6isReached='AECB54', L5isReached='FFCC00', L4isReached='F7B101', L3isReached='EC6607', L2isReached='E63312', L1isReached='AE0F0B', L9isReached='f2f2f2', L8isReached='f2f2f2', CardColor1='E6E6E6', CardColor2='E6E6E6', CardColor3='E6E6E6', CardColor4='E6E6E6', CardColor5='E6E6E6', CardColor6='E6E6E6', CardColor7='E6E6E6', CardColor8='ffffff', CardColor9='ffffff' WHERE id=$id";
              if ($conn->query($sql) === TRUE) {
                header("Location: dashboard.php");
                } else {
                  echo "Error updating record: " . $conn->error;
                ...
                $sql = "UPDATE IRLscales SET L8isReached='008F51', L7isReached='73B959', L6isReached='AECB54', L5isReached='FFCC00', L4isReached='F7B101', L3isReached='EC6607', L2isReached='E63312', L1isReached='AE0F0B', L9isReached='f2f2f2', CardColor1='E6E6E6', CardColor2='E6E6E6', CardColor3='E6E6E6', CardColor4='E6E6E6', CardColor5='E6E6E6', CardColor6='E6E6E6', CardColor7='E6E6E6', CardColor8='E6E6E6', CardColor9='ffffff' WHERE id=$id";
                if ($conn->query($sql) === TRUE) {
                  header("Location: dashboard.php");
                  } else {
                    echo "Error updating record: " . $conn->error;
